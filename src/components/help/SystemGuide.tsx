...
export const SYSTEM_GUIDE_TOPICS:GuideTopic[]=[
  topic('dashboard','مرکز فرمان زنجیره تأمین','فضای کاری','تصویر کلان همکاری هتل‌ها، آنلاین‌سازی نرخ و ظرفیت، فرصت مهاجرت Provider، کش‌فلو، فروش، موانع و بار کاری کارشناسان است.',['ihos_hotels','ihos_hotel_automation','ihos_provider_rules','ihos_provider_coverage','ihos_hotel_assignments','ihos_hotel_financial_profiles','ihos_hotel_sales_metrics','ihos_hotel_blockers','ihos_work_reports'],['تصویر کلان و اقدام‌های فوری را مرور کنید.','در تب آنلاین‌سازی هتل‌های قابل مهاجرت را بررسی کنید.','از تب مالی، تیم یا ورود داده وارد جزئیات شوید.'],['ظرفیت و نرخ وزن مستقل دارند و مجموع آن‌ها ۱۰۰ است.','هتل چند-Providerی در شاخص کل فقط یک بار محاسبه می‌شود.','آنلاین دستی از آنلاین API یا پنل هتل تفکیک و زمان آن در بار کاری منظور می‌شود.']),
  topic('workReports','گزارش کار سریع','جریان کار','ثبت سریع و ساخت‌یافته اقدام کارشناس برای جایگزینی Google Sheet است؛ گزارش به هتل، زمان، وزن، نتیجه، کد رزرو، ارتباط و پیگیری بعدی متصل می‌شود.',['ihos_work_action_types','ihos_work_reports','ihos_hotel_communications','ihos_hotel_blockers','ihos_tasks'],['هتل و نوع اقدام را انتخاب کنید.','نتیجه، زمان و در صورت نیاز کد رزرو را وارد کنید.','پیگیری یا مانع را همان لحظه به تسک تبدیل کنید.'],['برای اقدام‌های رزروی کد رزرو الزامی است.','دکمه تماس EyeBeam ابتدا لاگ را ذخیره و سپس شماره هتل را به نرم‌افزار تماس می‌فرستد.','وزن هر اقدام در KPI کارشناسان استفاده می‌شود.']),
  ...
  topic('hotelOwnership','مالکیت پرونده هتل','عملیات هتل','چهار مسئول اصلی هر هتل را مشخص می‌کند و با فایل تخصیص کارشناسان نرخ و ظرفیت همگام می‌ماند.',['ihos_hotel_assignments','ihos_users','ihos_hotels','ihos_hotel_automation'],['فایل تخصیص را از بخش کارشناسان وارد کنید یا هتل را جستجو کنید.','برای هر نقش کاربر فعال انتخاب کنید.','ذخیره کنید؛ همه نماهای مالکیت با Realtime تازه می‌شوند.']),
  topic('contracts','قرارداد مالی و پرداخت','عملیات هتل','نوع قرارداد، مدل تسویه، دوره خرید و پرداخت، سقف اعتبار و دسته ریسک مالی هتل را مدیریت می‌کند.',['ihos_hotel_financial_profiles','ihos_hotels'],['روی ستون نمودار دسته مالی کلیک کنید تا همان هتل‌ها فیلتر و مرتب شوند.','پروفایل مالی را تکمیل کنید.','دسته ریسک و شرایط تسویه را بازبینی کنید.']),
  ...
  topic('calendar','تقویم عملیاتی','جریان کار','تسک‌ها، رویدادها، یادآورها، مناسبت‌های ملی و تعطیلات رسمی ۱۴۰۵ را در تقویم واقعی شمسی نشان می‌دهد.',['ihos_calendar_events','ihos_tasks','ihos_reminders','تقویم رسمی کشور'],['نمای ماه، هفته یا فهرست را انتخاب کنید.','براساس کارشناس یا نوع، از جمله تعطیل رسمی، فیلتر کنید.','رویداد جدید را ثبت یا با دکمه امروز به ماه جاری برگردید.']),
  topic('messages','پیام‌رسان داخلی','جریان کار','گفت‌وگوی سازمانی، تیمی و مستقیم را جدا نگه می‌دارد و برای هر گیرنده اعلان پایدار می‌سازد.',['ihos_messages','ihos_notifications','ihos_users','ihos_hotels'],['سازمان، تیم یا شخص را انتخاب کنید.','در صورت نیاز هتل مرتبط را مشخص کنید.','ارسال کنید و تعداد اعلان‌های ساخته‌شده را در پیام وضعیت ببینید.']),
