...
const ControlTowerV18=dynamic(()=>import('@/components/enterprise/V18ExecutionIntelligence').then(m=>m.ControlTowerV18),{ssr:false});
const HotelOwnershipV18=dynamic(()=>import('@/components/enterprise/V18ExecutionIntelligence').then(m=>m.HotelOwnershipV18),{ssr:false});
const KpiCenterV18=dynamic(()=>import('@/components/enterprise/V18ExecutionIntelligence').then(m=>m.KpiCenterV18),{ssr:false});
const CommunicationsCenterV18=dynamic(()=>import('@/components/enterprise/V18ExecutionIntelligence').then(m=>m.CommunicationsCenterV18),{ssr:false});
const AutomationOperationsV18=dynamic(()=>import('@/components/enterprise/V18ExecutionIntelligence').then(m=>m.AutomationOperationsV18),{ssr:false});
...
const initialRoles:Role[]=[{id:'role-admin',title:'مدیر سیستم',description:'دسترسی کامل',permissions:defaultPerms(true),is_system:true},{id:'role-city',title:'سیتی منیجر',description:'مدیریت منطقه و تیم',permissions:{...defaultPerms(false),dashboard:true,inbox:true,controlTower:true,crm360:true,reports:true,riskRadar:true,tasks:true,tasks_create:true,tasks_edit:true,assignments:true,approvals:true,sla:true,hotels:true,hotelOwnership:true,contracts:true,communications:true,calendar:true,documents:true,documents_upload:true,team:true,kpiCenter:true,reminders:true,projects:true,goals:true,notifications:true,logs:true},is_system:true},{id:'role-expert',title:'کارشناس',description:'اجرای تسک‌های شخصی',permissions:{...defaultPerms(false),dashboard:true,inbox:true,tasks:true,tasks_create:true,tasks_edit:true,hotels:true,communications:true,calendar:true,documents:true,reminders:true,notifications:true},is_system:true}];
